...
STRINGS = {
    "ru": {
        ...
        "welcome_intro": (
            ...
            "Если нашли баг, репортните пожалуйста через кнопку: \n\n"
            "🐛 Сообщить о баге"
        ),
        "welcome": (
            "💪 *Турникмен*\n\n"
        ...
        "about": (
            ...
            "3. Укажи имя, вес и дневную норму подтягиваний\n"
            "4. Укажи день программы _(1 — если ты только начинаешь)_\n\n"
            "📅 *Ежедневный план (7-дневный цикл)*\n"
            "Бот чередует нагрузку по дням:\n"
            "• Средний — ~100% нормы\n"
            "• Лёгкий — ~60–70% нормы\n"
            ...
            "4. Оцени усилие (RPE) и добавь заметку — по желанию\n\n"
            "📊 *RPE — оценка усилия*\n"
            "После тренировки бот спросит: насколько тяжело было?\n"
            "1–3 — очень легко · 4–6 — нормально · 7–8 — тяжело · 9–10 — на пределе\n"
            "Бот использует эти оценки чтобы корректировать план автоматически.\n\n"
            "🔥 *Стрик*\n"
            "Стрик — дней подряд с тренировкой. Если пропустил — бот предложит "
            "потратить токен заморозки, чтобы не потерять серию.\n\n"
    ...
    "en": {
        ...
        "about": (
            ...
            "3. Enter your name, weight, and daily pullup target\n"
            "4. Enter your program day _(1 if you're just starting out)_\n\n"
            "📅 *Your Daily Plan (7-day wave cycle)*\n"
            "The bot alternates load throughout the week:\n"
            "• Medium — ~100% of your target\n"
            "• Light — ~60–70% of your target\n"
            "• Heavy — ~120–130% of your target\n"
            "• Rest — recovery day\n"
            "• Density — many short sets\n"
            "This prevents adaptation and accelerates growth.\n\n"
            "🏋️ *How to Train*\n"
            "1. Tap «🏋️ Training»\n"
            "2. Do sets — tap the numbers or «✏️ Enter Manually»\n"
            "3. Tap «✅ Finish Training» when done\n"
            "4. Rate your effort (RPE) and add a note — optional\n\n"
            "📊 *RPE — Effort Rating*\n"
            "After each session the bot asks: how hard was it?\n"
            "1–3 = very easy · 4–6 = moderate · 7–8 = hard · 9–10 = near maximum\n"
            "The bot uses these ratings to automatically adjust your plan.\n\n"
            "🔥 *Streak*\n"
            "Your streak counts days trained in a row. Miss a day? The bot will offer "
            "a freeze token to protect your streak.\n\n"
            "📈 *Stats & History*\n"
            "«📊 Statistics» — your progress, XP, level, streak\n"
