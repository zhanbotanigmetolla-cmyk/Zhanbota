...
STRINGS = {
    "ru": {
        ...
        "welcome_intro": (
            ...
            "адаптировать план тренировок и не терять мотивацию. Бот полностью бесплатный, навсегда.\n\n"
        ...
        "about_page2": (
            ...
            "Максимум — 5 токенов.\n\n"
            "🤖 *Турникмен AI:*\n"
            "Чат с ИИ на базе Google Gemini 3 Flash. Знает всю историю твоих тренировок. "
    ...
    "en": {
        ...
        "about_page2": (
            ...
            "Maximum 5 tokens.\n\n"
            "🤖 *Turnikmen AI:*\n"
            "Full chat powered by Google Gemini 3 Flash. It knows your entire training history. "
